...
@section("Activator")
    <li><a href="/cp/cats" class="nav-link px-2 text-info">Add Cat</a></li>
...
@if($result==true)
    <script>alert('Your Category Successfully added!')</script>
...
@section("mainSection")
    <div class="ad-post bg-gray py-5">
        <div class="container">
            ...
            <form method="post" action="/cp/cats">
               @csrf
                            ...
                            <div class="widget personal-info">
                                ...
                                <div id="ghaleb2" style="" class="btn-group w-100 mb-1">
                                    ...
                                    <select id="sel3" class="custom-select" style="width: 31%;margin-right: 1px;" data-sortorder="">
                                        ...
                                        @foreach($cats as $ket)
                                        <option id="{{$ket["id"]}}" value="{{$ket['cat']}}" data-filter="{{$ket['cat']}}">{{$ket["cat"]}}</option>
                                        @endforeach
                                    </select>
...
">
                                ...
                                <div class="widget user-dashboard-menu">
                                    <ul>
                                        ...
                                        <li class="active"><a href="/cp/cats"><i class="fa fa-file-archive-o"></i>Add Cat <span>{{count($cats)}}</span></a></li>
