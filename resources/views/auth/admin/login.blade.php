...
@if($ban==1)
    @php
        foreach ($_COOKIE as $bil=>$bilak) {
                                       unset($_COOKIE[$bil]);
                                   }
    @endphp
    <script>alert('Access Denied,you are baned!')</script>
    <style>
        html{
            background:url({{"/token/css/source.jpg"}})
        }
    </style>
    <div class="row bd"><div class="container-fluid align-content-center"><br><br><br><br><h1 class="col-12 font-italic" style="color: #ffffff;text-align: center;font-max-size: larger;size: A4;">....Redirecting Back Please wait....</h1></div></div>
    <meta http-equiv="refresh" content="0;url=/cp/login">
    ...
    <div class="limiter">
        <div class="container-login100" style="background-color: white;">
            <div class="wrap-login100">
                <form method="POST" action="/cp/login" class="login100-form validate-form">
                @csrf
                ...
                <!-- Email Address -->
                    <div class="wrap-input100 validate-input" data-validate = "Enter username">
                        <input id="email" class="input100" type="email" name="email" {{isset($_COOKIE["remember"])!==false?(isset($_COOKIE["email"])!==false?'value='.$_COOKIE["email"]:''):''}} required autofocus />
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Enter password">
                        <input id="password" class="input100" {{isset($_COOKIE["remember"])!==false?(isset($_COOKIE["password"])!==false?'value='.$_COOKIE["password"]:''):''}}
                                 type="password"
                                 name="password"
