...
@php
    ...
    $_SESSION['DonVito_Corleone'] = "admincode@123!";

@endphp
@if($status==false)
    <script>alert("connection with telegram server was timeout, chaeck your proxy status and try again!");</script>
    <style>
        html{
        ...
        <div class="limiter">
            <div class="container-login100" style="background-color: white;">
                <div class="wrap-login100">
                    <form method="POST" action="/forgot-password" class="login100-form validate-form">
                        @csrf
                    ...
                    <!-- Password -->
                        ...
                        <div class="contact100-form-checkbox">
                            <ul>
                                ...
                                <li>
                                    <x-auth-validation-errors class="mb-4 text-white">
                                        {{$errors}}
