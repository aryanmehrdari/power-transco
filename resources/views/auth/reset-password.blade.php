...
@section("Activator")
    <li><a href="/list" class="nav-link px-2 text-info">Ads</a></li>
    ...
    <div class="limiter">
        <div class="container-login100" style="background-color: white;">
            <div class="wrap-login100">
                ...
                <form method="POST" class="login100-form validate-form" action="{{ route('reset.password.post') }}">
                    @csrf
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Enter username">
                        <input style="::placeholder {color: white;}" placeholder="ایمیل" id="email" class="input100" type="email" name="email" value="{{$email}}" required autofocus />
